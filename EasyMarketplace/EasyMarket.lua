...
Methods.ItemChoose = function(pid)
...
Methods.AskGui = function(pid, targetpid, thing, gold)
...
tes3mp.CustomMessageBox(targetpid, 364, message, "OK;NO")
...
Methods.TradeItem = function(pid, targetpid, thing, gold)
...
if idGui == 364 then 
	if tonumber(data) == 0 then
		Methods.TradeItem(Players[pid].data.customVariables.WantsToTradeWith, pid, Players[pid].data.customVariables.WantsToTradeThing, Players[pid].data.customVariables.WantsToTradeGold)
	else
