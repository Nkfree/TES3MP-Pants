...
-- Add [ Credits = require("Credits") ] to the top of myMod.lua

--Find the Command Chain in server.lua and puttt into it:
--[[
elseif cmd[1] == credits then Credits.Show(pid)
]]


Credits.Show = function(pid)
    local motd = os.getenv("MOD_DIR") .. "/credits.txt"
    local message
